...
This is the fourth binary release of Wiseman, an implementation of the WS Management 
...
directory and try the 'server_guide' and the 'tutorial' documents in the docs directory.  
The 1.0 binary release of this product will provide a comprehensive rework of the current 
...
While learning more about Wiseman, you will also find the Developer docs located in the 
docs/developer directory and refer to the unit tests for wiseman to 
