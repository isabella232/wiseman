...
/* This enumeration factory is for the <i>Servicetypemodelresource</i> resource.
 * It handles creation of an iterator for use to access 
 * the <i>Servicetypemodelresource</i> resources.
 *
 * @see com.sun.ws.management.server.IteratorFactory
 *
 */
public final class ServicetypemodelresourceIteratorFactory implements IteratorFactory {
     ...
     */
     ServicetypemodelresourceIteratorFactory(final String resourceURI) {
         this.resourceURI = resourceURI;
         this.factory = new com.hp.itil._2007._05.servicetype.ObjectFactory();
    }
    
    /** This creates iterators for the <i>Servicetypemodelresource</i> resource.
     * 
    ...
    public final EnumerationIterator newIterator(HandlerContext context,
        ...
        return new ServicetypemodelresourceEnumerationIterator(context, resourceURI, request.getXmlBinding(), factory, 
     ...
     */
    public final class ServicetypemodelresourceEnumerationIterator implements EnumerationIterator {
        ...
        /**
         * Constructor used by the ServicetypemodelresourceIteratorFactory
         */
        protected ServicetypemodelresourceEnumerationIterator(final HandlerContext context,
            ...
            */
            ...
            this.log = Logger.getLogger(ServicetypemodelresourceEnumerationIterator.class.getName());
            ...
            //
            //       com.sun.ws.management.xml.custom.packagenames = com.hp.itil._2007._05.servicetype
            //
         ...
         * @return an {@link EnumerationElement Element} that is used to
          ...
          */
           public final EnumerationItem next() {
            ...
            final ServiceTypeType value = new ServiceTypeType();
            ...
            final JAXBElement<ServiceTypeType> item = 
                             this.factory.createServiceTypeModel(value);
