...
import net.java.jvm.ObjectFactory;
...
/* This enumeration factory is for the <i>Threadinfo</i> resource.
 * It handles creation of an iterator for use to access 
 * the <i>Threadinfo</i> resources.
 *
 * @see com.sun.ws.management.server.IteratorFactory
 *
 */
public final class ThreadinfoIteratorFactory implements IteratorFactory {
     ...
     */
     ThreadinfoIteratorFactory(final String resourceURI) {
         this.resourceURI = resourceURI;
         this.factory = new net.java.jvm.ObjectFactory();
    }
    
    /** This creates iterators for the <i>Threadinfo</i> resource.
     * 
    ...
    public final EnumerationIterator newIterator(HandlerContext context,
        ...
        return new ThreadinfoEnumerationIterator(context, resourceURI, request.getXmlBinding(), factory, 
     ...
     */
    public final class ThreadinfoEnumerationIterator implements EnumerationIterator {
        ...
        /**
         * Constructor used by the ThreadinfoIteratorFactory
         */
        protected ThreadinfoEnumerationIterator(final HandlerContext context,
            ...
            */
            ...
            this.log = Logger.getLogger(ThreadinfoEnumerationIterator.class.getName());
         ...
         * @return an {@link EnumerationElement Element} that is used to
          ...
          */
           public final EnumerationItem next() {
            ...
            final ThreadType value = new ThreadType();
            ...
            final JAXBElement<ThreadType> item = 
                             this.factory.createThread(value);
