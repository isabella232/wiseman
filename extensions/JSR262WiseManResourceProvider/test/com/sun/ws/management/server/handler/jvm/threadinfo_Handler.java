...
package com.sun.ws.management.server.handler.jvm;
...
import jvm.threadinfo.ThreadinfoHandler;

/**
 * This Handler delegates to the jvm.threadinfo.ThreadinfoHandler class.
 * There is typically nothing to implement in this class.
 *
 * @GENERATED
 */
public class threadinfo_Handler extends DelegatingHandler
{
    // Log for logging messages
    @SuppressWarnings("unused")
    private final Logger log;

    private static final ThreadinfoHandler delegate = new ThreadinfoHandler();
    
    /**
     * Handler constructor.
     */
    public threadinfo_Handler() {
        super(delegate);    
        log = Logger.getLogger(threadinfo_Handler.class.getName());
    } 
