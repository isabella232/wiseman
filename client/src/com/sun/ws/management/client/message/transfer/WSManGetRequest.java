...
public class WSManGetRequest extends WSManTransferRequest {
	
    public static final String ACTION_URI = "http://schemas.xmlsoap.org/ws/2004/09/transfer/Get";

	WSManGetRequest() {
        super();
	}
	
	public WSManGetRequest(final EndpointReferenceType epr,
	...
	public WSManGetRequest(final String endpoint,
	...
	public WSManGetRequest(final SOAPRequest request) throws JAXBException {
		super(request);
		setAction(ACTION_URI);
	}
	...
	public SOAPResponse invoke() throws Exception {
		...
		return new WSManGetResponse(super.invoke());
	}
}
