 ...
 ** 
 *
 * $Id: Interop20060801Test.java,v 1.1 2007-06-04 06:25:11 denis_rachal Exp $
 */
...
//	}
	 ...
	 * <li>
	 * <ul>Client sends enumeration request</li>
	 * <ul>Server sends response along with enumeration context A</li>
	 * <ul>Client does a Pull request using enumeration context A</li>
	 * <ul>Server responds with results along with enumeration context B</li>
	 * <ul>Client does a Pull request using enumeration context B</li>
	 * <ul>This continues until Server responds with results and EndOfSequence indicating there 
	 * 			are no more results</li>
	 * </li>
	 * 
	 * @throws DatatypeConfigurationException 
	 * @throws FaultException 
	 ...
	 * The sequence of operations is as follows:
	 * <li>
	 * <ul>Client sends enumeration request</ul>
	 * <ul>Server sends response along with enumeration context A</ul>
	 * <ul>Client does a Pull request using enumeration context A</ul>
	 * <ul>Server responds with results along with enumeration context B</ul>
	 * <ul>Client does a Pull request using enumeration context C</ul>
	 * <ul>Server returns an error</ul>
	 * </li>
	 * @throws DatatypeConfigurationException 
	 * @throws FaultException 
	 * @throws IOException 
