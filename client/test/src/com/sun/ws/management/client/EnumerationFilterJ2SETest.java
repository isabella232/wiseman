 ...
 **
 **
 * $Id: EnumerationFilterJ2SETest.java,v 1.1.2.3 2008-05-20 15:10:38 denis_rachal Exp $
 */
 ...
 */
public class EnumerationFilterJ2SETest extends EnumerationFilterBase {

	public EnumerationFilterJ2SETest(String testName) {
		super(testName);
	}
	...
	public static Test suite() {
		final TestSuite suite = new TestSuite(
				EnumerationFilterJ2SETest.class);
		return suite;
	}
}