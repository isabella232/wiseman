 ...
 *
 * $Id: ReflectiveRequestDispatcher.java,v 1.17 2006-11-02 20:45:05 obiwan314 Exp $
 */
...
public final class ReflectiveRequestDispatcher extends RequestDispatcher {
	...
	private static final String HANDLER_PREFIX = ReflectiveRequestDispatcher.class
			.getPackage().getName()
			+ ".handler";
	...
	private String createHandlerClassName(final String resource) {
		...
		final String pkg = com.sun.xml.bind.api.impl.NameConverter.standard
				.toPackageName(resource);
