 ...
 *
 * $Id: exec_Handler.java,v 1.1 2006-04-14 22:15:12 akhilarora Exp $
 */
...
public class exec_Handler implements Handler, EnumerationIterator {
    ...
    public void handle(final String action, final String resource,
        ...
        final Map<String, Object> selectors = request.getSelectors();
        final Object cmd = selectors.get(EXEC);
        if (cmd == null) {
            throw new InvalidSelectorsFault("Selector not found: " + EXEC);
        }
