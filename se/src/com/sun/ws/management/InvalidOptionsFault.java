 ...
 *
 * $Id: InvalidOptionsFault.java,v 1.1 2005-06-29 19:18:14 akhilarora Exp $
 */
...
public class InvalidOptionsFault extends SenderFault {
    ...
    public InvalidOptionsFault(final String faultDetail) {
        this(SOAP.createFaultDetail(null, faultDetail, null, null));
    }
    
    public InvalidOptionsFault(final Node... details) {
        super(Management.INVALID_OPTIONS, Management.INVALID_OPTIONS_REASON, details);
    }
}
