 ...
 *
 * $Id: InvalidRepresentationFault.java,v 1.1 2005-06-29 19:18:26 akhilarora Exp $
 */
...
public class InvalidRepresentationFault extends SenderFault {
    ...
    public InvalidRepresentationFault(final String faultDetail) {
        this(SOAP.createFaultDetail(null, faultDetail, null, null));
    }
    
    public InvalidRepresentationFault(final Node... details) {
        super(Transfer.INVALID_REPRESENTATION, Transfer.INVALID_REPRESENTATION_REASON, details);
    }
}
