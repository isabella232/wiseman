 ...
 */
public class WSManReflectiveAgent2 extends WSManAgentSupport {
    private static final String METADATA_PROPERTY_FILE_NAME = "/metadata.properties";
    private Map<String, String> metadataProperties;

    public WSManReflectiveAgent2() throws SAXException {
        this(null, null, null);
    }

    protected WSManReflectiveAgent2(Map<String,String> wisemanConf, Source[] customSchemas,
