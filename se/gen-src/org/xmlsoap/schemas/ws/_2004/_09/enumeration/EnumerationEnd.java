...
public class EnumerationEnd {
    ...
    @XmlElement(name = "Code", namespace = "http://schemas.xmlsoap.org/ws/2004/09/enumeration", required = true)
    protected String code;
    @XmlElement(name = "Reason", namespace = "http://schemas.xmlsoap.org/ws/2004/09/enumeration", required = true)
