...
@XmlType(name = "OperationType", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
public class OperationType {

    @XmlElement(name = "Action", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = String.class)
    protected List<String> action;
    @XmlElement(name = "SelectorSetRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = SimpleRefType.class)
    protected List<SimpleRefType> selectorSetRef;
    @XmlElement(name = "OptionSetRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = SimpleRefType.class)
    protected List<SimpleRefType> optionSetRef;
    @XmlElement(name = "SchemaRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = SchemaRefType.class)
    protected List<SchemaRefType> schemaRef;
    @XmlElement(name = "FilterDialect", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = String.class)
    protected List<String> filterDialect;
    @XmlElement(name = "DeliveryMode", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat", type = String.class)
    protected List<String> deliveryMode;
    @XmlAttribute(name = "WsdlLocation", namespace = "")
    protected String wsdlLocation;
    @XmlAttribute(name = "WsdlPort", namespace = "")
    @XmlJavaTypeAdapter(value = CollapsedStringAdapter.class)
    protected String wsdlPort;
    @XmlAttribute(name = "WsdlRef", namespace = "")
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link org.xmlsoap.schemas.ws._2005._02.wsmancat.SimpleRefType}
     * 
     */
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link org.xmlsoap.schemas.ws._2005._02.wsmancat.SchemaRefType}
     * 
     */
