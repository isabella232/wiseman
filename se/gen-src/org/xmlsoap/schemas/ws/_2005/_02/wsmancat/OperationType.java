 ...
 *         &lt;element name="SelectorSetRef" type="{http://schemas.xmlsoap.org/ws/2005/02/wsmancat}SimpleRefType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="OptionSetRef" type="{http://schemas.xmlsoap.org/ws/2005/02/wsmancat}SimpleRefType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="SchemaRef" type="{http://schemas.xmlsoap.org/ws/2005/02/wsmancat}SchemaRefType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OperationType {
    ...
    @XmlElement(name = "Action", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
    protected List<String> action;
    @XmlElement(name = "SelectorSetRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
    protected List<SimpleRefType> selectorSetRef;
    @XmlElement(name = "OptionSetRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
    protected List<SimpleRefType> optionSetRef;
    @XmlElement(name = "SchemaRef", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
    protected List<SchemaRefType> schemaRef;
    @XmlElement(name = "FilterDialect", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
    protected List<String> filterDialect;
    @XmlElement(name = "DeliveryMode", namespace = "http://schemas.xmlsoap.org/ws/2005/02/wsmancat")
