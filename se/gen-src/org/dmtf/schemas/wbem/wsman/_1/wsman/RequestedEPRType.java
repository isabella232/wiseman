...
public class RequestedEPRType {
    ...
    @XmlElement(name = "EPRInvalid", namespace = "http://schemas.dmtf.org/wbem/wsman/1/wsman.xsd")
    protected AttributableEmpty eprInvalid;
    @XmlElement(name = "EPRUnknown", namespace = "http://schemas.dmtf.org/wbem/wsman/1/wsman.xsd")
