...
@XmlType(name = "faultcode", namespace = "http://www.w3.org/2003/05/soap-envelope")
public class Faultcode {

    @XmlElement(name = "Value", namespace = "http://www.w3.org/2003/05/soap-envelope", type = QName.class)
    protected QName value;
    @XmlElement(name = "Subcode", namespace = "http://www.w3.org/2003/05/soap-envelope", type = Subcode.class)
